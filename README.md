...
<a href="https://github.com/Quad4-Software/ai/actions/workflows/ci.yml"><img src="https://img.shields.io/github/actions/workflow/status/Quad4-Software/ai/ci.yml?branch=master&logo=github&label=ci" alt="ci"></a>
<a href="https://github.com/Quad4-Software/ai/actions/workflows/gosec.yml"><img src="https://img.shields.io/github/actions/workflow/status/Quad4-Software/ai/gosec.yml?branch=master&logo=github&label=gosec" alt="gosec"></a>
<a href="https://github.com/Quad4-Software/ai/actions/workflows/race.yml"><img src="https://img.shields.io/github/actions/workflow/status/Quad4-Software/ai/race.yml?branch=master&logo=github&label=race" alt="race"></a>
<a href="https://github.com/Quad4-Software/ai/releases/latest"><img src="https://img.shields.io/github/v/release/Quad4-Software/ai?logo=github&label=release" alt="release"></a>
<a href="https://github.com/Quad4-Software/ai/blob/master/agents-mcp/go.mod"><img src="https://img.shields.io/github/go-mod/go-version/Quad4-Software/ai?filename=agents-mcp/go.mod&logo=go&label=go%20version" alt="go version"></a>
<a href="https://github.com/Quad4-Software/ai/blob/master/LICENSE"><img src="https://img.shields.io/github/license/Quad4-Software/ai?logo=opensourceinitiative&label=license" alt="license"></a>
...
~/.cursor/mcp.json under mcpServers, for example:
