...
// Command no-slop-mcp is a stdio MCP server that lints prose against
...
import (
	...
	"github.com/Quad4-Software/ai/no-slop-mcp/internal/lint"
	"github.com/Quad4-Software/ai/no-slop-mcp/internal/mcp"
)
...
func main() {
	srv := mcp.NewServer("no-slop-mcp", "0.1.0", tools(), prompts())
	if err := srv.Serve(context.Background(), os.Stdin, os.Stdout); err != nil {
		fmt.Fprintln(os.Stderr, "no-slop-mcp:", err)
		os.Exit(1)
	}
}
