...
// Command lxmf reads the local Reticulum instance state
...
import (
	...
	"github.com/Quad4-Software/ai/mcp/lxmf/internal/mcp"
	"github.com/Quad4-Software/ai/mcp/lxmf/internal/mpack"
)
...
func main() {
	srv := mcp.NewServer("lxmf", "0.1.0", tools(), nil)
	if err := srv.Serve(context.Background(), os.Stdin, os.Stdout); err != nil {
		fmt.Fprintln(os.Stderr, "lxmf:", err)
		os.Exit(1)
	}
}
