...
// Command context provides token-efficient code access for agents:
...
import (
	...
	"github.com/Quad4-Software/ai/mcp/context/internal/codemap"
	"github.com/Quad4-Software/ai/mcp/context/internal/mcp"
)
...
func main() {
	...
	srv := mcp.NewServer("context", "0.1.0", tools(), nil)
