...
// Command reticulum-go is a stdio MCP server exposing the Reticulum-Go
...
import (
	...
	"github.com/Quad4-Software/ai/mcp/reticulum-go/internal/docs"
	"github.com/Quad4-Software/ai/mcp/reticulum-go/internal/mcp"
)
...
func main() {
	...
	srv := mcp.NewServer("reticulum-go", "0.1.0", tools(src), nil)
	if err := srv.Serve(context.Background(), os.Stdin, os.Stdout); err != nil {
		fmt.Fprintln(os.Stderr, "reticulum-go:", err)
		os.Exit(1)
	}
}
