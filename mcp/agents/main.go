...
// Command agents exposes a repo's .agents knowledge graph and docs
...
import (
	...
	"github.com/Quad4-Software/ai/mcp/agents/internal/mcp"
)
...
func main() {
	...
	srv := mcp.NewServer("agents", "0.1.0", append(tools(), askTool, fuzzySearchTool), nil)
