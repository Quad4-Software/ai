...
// Command memory is a write-capable MCP server that stores, searches,
...
import (
	...
	"github.com/Quad4-Software/ai/mcp/memory/internal/mcp"
)
...
func main() {
	_ = ensureStore()
	srv := mcp.NewServer("memory", "0.1.0", tools(), nil)
