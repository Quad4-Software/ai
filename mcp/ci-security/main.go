...
// Command ci-security provides CI security guidance and scanning:
...
import (
	...
	"github.com/Quad4-Software/ai/mcp/ci-security/internal/cisec"
	"github.com/Quad4-Software/ai/mcp/ci-security/internal/docs"
	"github.com/Quad4-Software/ai/mcp/ci-security/internal/mcp"
)
...
func main() {
	...
	srv := mcp.NewServer("ci-security", "0.1.0", tools(src), prompts())
	if err := srv.Serve(context.Background(), os.Stdin, os.Stdout); err != nil {
		fmt.Fprintln(os.Stderr, "ci-security:", err)
		os.Exit(1)
	}
}
