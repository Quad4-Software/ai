...
// Command meshchatx is a stdio MCP server exposing the MeshChatX
...
import (
	...
	"github.com/Quad4-Software/ai/mcp/meshchatx/internal/docs"
	"github.com/Quad4-Software/ai/mcp/meshchatx/internal/mcp"
	"github.com/Quad4-Software/ai/mcp/meshchatx/internal/refactor"
	"github.com/Quad4-Software/ai/mcp/meshchatx/internal/scaffold"
)
...
func main() {
	...
	srv := mcp.NewServer("meshchatx", "0.3.0", append(tools(src), issueTools()...), prompts(src))
	if err := srv.Serve(context.Background(), os.Stdin, os.Stdout); err != nil {
		fmt.Fprintln(os.Stderr, "meshchatx:", err)
		os.Exit(1)
	}
}
