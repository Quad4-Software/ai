...
// Command workspace wraps repo dev commands: Taskfile targets, git
...
import (
	...
	"github.com/Quad4-Software/ai/mcp/workspace/internal/mcp"
)
...
func main() {
	...
	srv := mcp.NewServer("workspace", "0.1.0", tools(), nil)
