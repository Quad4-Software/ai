...
// Command i18n checks locale coverage: missing keys across locale
...
import (
	...
	"github.com/Quad4-Software/ai/mcp/i18n/internal/mcp"
)
...
func main() {
	...
	srv := mcp.NewServer("i18n", "0.1.0", tools(), nil)
