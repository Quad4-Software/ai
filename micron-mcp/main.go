...
// Command micron-mcp is a stdio MCP server for Micron markup:
...
import (
	...
	"github.com/Quad4-Software/ai/micron-mcp/internal/mcp"
	"github.com/Quad4-Software/ai/micron-mcp/internal/templates"
)
...
func main() {
	srv := mcp.NewServer("micron-mcp", "0.1.0", tools(), nil)
	if err := srv.Serve(context.Background(), os.Stdin, os.Stdout); err != nil {
		fmt.Fprintln(os.Stderr, "micron-mcp:", err)
		os.Exit(1)
	}
}
