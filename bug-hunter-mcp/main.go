...
// Command bug-hunter-mcp combines bug-hunting methodology guidance with
...
import (
	...
	"github.com/Quad4-Software/ai/bug-hunter-mcp/internal/mcp"
	"github.com/Quad4-Software/ai/bug-hunter-mcp/internal/scan"
)
...
func main() {
	...
	root, err = findRoot()
	if err != nil {
		fmt.Fprintln(os.Stderr, "bug-hunter-mcp:", err)
		os.Exit(1)
	}
	srv := mcp.NewServer("bug-hunter-mcp", "0.1.0", tools(), prompts())
