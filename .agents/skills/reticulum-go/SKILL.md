...
reticulum-go-mcp exposes the Reticulum-Go docs at https://reticulum-go.quad4.io
as searchable, section-aware MCP tools. The server is Go stdlib only, low memory,
and fetches pages on demand over HTTPS.

## Tool reference

Tool details are in [references/tools.md](references/tools.md). This section is optional if reticulum-go-mcp is installed.
