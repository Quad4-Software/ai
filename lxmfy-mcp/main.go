...
// Command lxmfy-mcp is a stdio MCP server for LXMFy: searchable docs, bot
...
import (
	...
	"github.com/Quad4-Software/ai/lxmfy-mcp/internal/docs"
	"github.com/Quad4-Software/ai/lxmfy-mcp/internal/mcp"
	"github.com/Quad4-Software/ai/lxmfy-mcp/internal/scaffold"
)
...
func main() {
	...
	srv := mcp.NewServer("lxmfy-mcp", "0.1.0", tools(src), nil)
	if err := srv.Serve(context.Background(), os.Stdin, os.Stdout); err != nil {
		fmt.Fprintln(os.Stderr, "lxmfy-mcp:", err)
		os.Exit(1)
	}
}
